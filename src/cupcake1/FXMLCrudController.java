...
public class FXMLCrudController implements Initializable { 
    ...
    private void ajouter(ActionEvent event) {
        ...
        Date date_fi_i = Date.from(date_fin_inscription.getValue().atStartOfDay(ZoneId.systemDefault()).toInstant());
            ...
            test = true;
            message = "Champs Date_fin_incription éxpiration obligatoire"; }
        ...
        if (test) {
            ...
            Formation f = new Formation(date, date1, Integer.parseInt(nbr_participant.getText()), info_formation.getText(), date2, Integer.parseInt(nbr_heures.getText()), Config.id_user);
            try {
